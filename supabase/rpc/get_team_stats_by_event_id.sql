create or replace function public.get_team_stats_by_event_id(event_id_param bigint)
returns table (
    team_id bigint,
    team_name text,
    wins bigint,
...
-- grant execute on function public.get_team_stats_by_event_id(bigint) to anon, authenticated;
